...
public class Utility {
    ...
    public static String getPreferredLocation(Context context) {
        ...
        return preferences.getString(context.getString(R.string.pref_location_key), context.getString(R.string.pref_location_value));
    }
 ...
 /*   public static URL getArtUrlForWeatherCondition(){
    ...
    static public
    @SunRiseSyncAdapter.LocationStatus
    int getLocationStatus(Context context) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.getInt(context.getString(R.string.pref_location_status_key), SunRiseSyncAdapter.LOCATION_STATUS_UNKNOWN);
    }

    public static void resetLocationStatus(Context context) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(context.getString(R.string.pref_location_status_key), SunRiseSyncAdapter.LOCATION_STATUS_UNKNOWN).apply();
    }
