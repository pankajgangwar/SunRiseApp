...
/**
 * @author Pankaj Kumar
 * Defines table and column names for the weather table
 */
public class WeatherContract {

	public static final String CONTENT_AUTHORITY = "iriemo.bangaloreweather";
	...
	*/
	...
	public static final class WeatherEntry implements BaseColumns
	{
		...
		//mime type prefixes that specifies to either list items or directory
